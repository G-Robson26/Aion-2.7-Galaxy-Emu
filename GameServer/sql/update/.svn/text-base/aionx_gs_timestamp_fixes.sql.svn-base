...
-- ----------------------------
-- Fixes the players creation_date, deletion date, last_online so any corrupted records are set to NULL.
-- ----------------------------
...
-- ----------------------------
-- Fixes the inventory expireTime so any corrupted records are set to NULL.
-- ----------------------------
UPDATE `inventory` SET `expireTime` = NULL WHERE `expireTime` = '00-00-00 00:00:00';
