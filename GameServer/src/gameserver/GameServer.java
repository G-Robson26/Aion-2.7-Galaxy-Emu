...
import gameserver.taskmanager.TaskManagerFromDB; /** TaskManager for gameserver Added by flegelDEV and resurrected */
...
public class GameServer {
    ...
    public static void main(String[] args) {
		...
		TaskManagerFromDB.getInstance(); /** TaskManager for gameserver Added by flegelDEV and resurrected*/
		...
		log.info((new StringBuilder()).append("Race Count : Elyos = ").append(ELYOS_COUNT).append(" Asmodians = ").append(ASMOS_COUNT).toString());
        log.info((new StringBuilder()).append("Race Ratios : Elyos = ").append(ELYOS_RATIO).append(" Asmodians = ").append(ASMOS_RATIO).toString());
