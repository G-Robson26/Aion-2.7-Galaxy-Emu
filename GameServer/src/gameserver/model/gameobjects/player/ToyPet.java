...
public class ToyPet
{
	...
	private long cdCaring = 0;
    private long cdGift = 0;
	...
	private boolean autoLoot = false;
	...
	public int getFullCaringTime() {
        long l1 = getCdCaring() + 600000L;
        long l2 = l1 - Calendar.getInstance().getTimeInMillis();
        if (l2 <= 0L) {
            setCdCaring(0L);
            return 0;
        }
    ...
    public int getFullGiftTime() {
        long l1 = getCdGift() + 3600000L;
        long l2 = l1 - Calendar.getInstance().getTimeInMillis();
        if (l2 <= 0L)  {
            setCdGift(0L);
            return 0;
	...
	public boolean getFullDismissTime() {
        long l1 = getDismissTime() + 600000L;
        long l2 = l1 - Calendar.getInstance().getTimeInMillis();
        if (l2 <= 0L) {
            setDismissTime(0L);
            setMood(0);
	...
	public void setCdCaring(long cdCaring){
        this.cdCaring = cdCaring;
    }

    public long getCdCaring(){
        return cdCaring;
    }

    public void setCdGift(long cdGift) {
        this.cdGift = cdGift;
    }

    public long getCdGift() {
        return cdGift;
    }
