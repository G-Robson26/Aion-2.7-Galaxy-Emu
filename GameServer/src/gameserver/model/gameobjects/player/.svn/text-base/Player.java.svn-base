...
public class Player extends Creature {
	...
	private boolean isTeleportUsed;
	...
	private boolean in_academy_revive;
	private boolean	in_academy;
	private int lastToyPet = 0;
	private int academySoloStage = 0;
	private int academySoloRound = 0;
	private int academySoloPool = 0;
    ...
    */
	...
	public boolean isTeleportUsed() {
        return this.isTeleportUsed;
    }

    public void setTeleportUsed(boolean isTeleportUsed){
        this.isTeleportUsed = isTeleportUsed;
    }
    ...
    {
        return getMembership() >= AdminConfig.MEMBER_LEVEL;
    }
    ...
    */
    ...
    public void setNrCategoryInGameShop(int nrCategoryinGameShop) {
   	...
   	/**
	 * For 2.5 Motion
   	 * @return the learnNinja
   	 */
   	public int getLearnNinja()
   	{
   		return learnNinja;
   	}

   	/**
   	 * @param learnNinja to set
   	 */
   	public void setLearnNinja(int learnNinja)
   	{
   		this.learnNinja = learnNinja;
   	}
    	
   	/**
  	 * @return the learnHober
   	 */
   	public int getLearnHober()
   	{
   		return learnHober;
   	}

   	/**
   	 * @param learnHober to set
   	 */
   	public void setLearnHober(int learnHober)
   	{
   		this.learnHober = learnHober;
   	}
    	
   	/**
   	 * @return the waitingMotion
   	 */
   	public int getWaitingMotion()
   	{
   		return waitingMotion;
   	}

   	/**
   	 * @param waitingMotion to set
   	 */
   	public void setWaitingMotion(int waitingMotion)
   	{
   		this.waitingMotion = waitingMotion;
   	}
    	
   	/**
   	 * @return the runningMotion
   	 */
   	public int getRunningMotion()
   	{
   		return runningMotion;
   	}

   	/**
   	 * @param waitingMotion to set
   	 */
   	public void setRunningMotion(int runningMotion)
   	{
   		this.runningMotion = runningMotion;
   	}
    	
   	/**
   	 * @return the jumpingMotion
   	 */
   	public int getJumpingMotion()
   	{
   		return jumpingMotion;
   	}

   	/**
   	 * @param waitingMotion to set
   	 */
   	public void setJumpingMotion(int jumpingMotion)
   	{
   		this.jumpingMotion = jumpingMotion;
   	}
    	
   	/**
   	 * @return the restMotion
   	 */
   	public int getRestMotion()
   	{
   		return restMotion;
   	}
   	 ...
   	 * @param waitingMotion to set
   	 */
   	public void setRestMotion(int restMotion)
   	{
   		this.restMotion = restMotion;
   	}
    	
   	/**
   	 * @param waitingMotion, runningMotion, jumpingMotion, restMotion to set
   	 */
   	public void setMotion(int waitingMotion, int runningMotion, int jumpingMotion, int restMotion)
   	{
   		this.waitingMotion = waitingMotion;
   		this.runningMotion = runningMotion;
   		this.jumpingMotion = jumpingMotion;
   	...
   	/**
   	 * @param learnNinja, learnHober, waitingMotion, runningMotion, jumpingMotion, restMotion to set
   	 */
   	public void setMotion(int learnNinja, int learnHober, int waitingMotion, int runningMotion, int jumpingMotion, int restMotion)
   	{
   		this.learnNinja = learnNinja;
   		this.learnHober = learnHober;
   		this.waitingMotion = waitingMotion;
	 ...
	 * academy
	 */
	public boolean getInAcademyRevive() {
        return in_academy_revive;
    }
	
	public void setInAcademyRevive(boolean flag) {
        in_academy_revive = flag;
    }
	
	public boolean getInAcademy() {
        return in_academy;
    }
	
	public void setInAcademy(boolean flag) {
        in_academy = flag;
    }
 
    public void setLastToyPet(int lastToyPet) {
       this.lastToyPet = lastToyPet;
    }

    public int getLastToyPet() {
        return lastToyPet;
    }
 
	public void setAcademySoloStage(int i) {
		academySoloStage = i;
		/* return; */
	}

	public int getAcademySoloStage() {
		return academySoloStage;
	}

	public void setAcademySoloRound(int i) {
		academySoloRound = i;
		/* return; */
	}

	public int getAcademySoloRound() {
		return academySoloRound;
	}

	public void setAcademySoloPool(int i) {
		academySoloPool = i;
		/* return; */
	}

	public int getAcademySoloPool() {
		return academySoloPool;
	}
    ...
    public void setInstanceBalaurKills(int i) {
        instanceBalaurKills = i;
    }
