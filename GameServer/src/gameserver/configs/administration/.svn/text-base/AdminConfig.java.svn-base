...
public class AdminConfig {
	...
	@Property(key="gameserver.administration.memberlevel", defaultValue="0")
    ...
    @Property(key = "gameserver.administration.command.spawn", defaultValue = "3")
	...
	@Property(key = "gameserver.administration.command.change", defaultValue = "3")
	public static int	CHANGE_ALL;
}
