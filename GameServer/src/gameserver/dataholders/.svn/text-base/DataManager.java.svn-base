...
import gameserver.dataholders.LevelUpSurveyData;
import gameserver.dataholders.PetFeedData;
import gameserver.dataholders.PresetData;
import gameserver.dataholders.ShieldData;
...
public final class DataManager {
	...
	public static AcademyData ACADEMY_DATA;
	
    public static AcademyShigoData ACADEMY_SHIGO_DATA;
	
    public static AcademyTeleportData ACADEMY_TELEPORT_DATA;
	
    public static AcademyBoxData ACADEMY_BOX_DATA;
	
	public static AcademySoloData ACADEMY_SOLO_DATA;
	...
	public static TradeInGoodsListData TRADEINGOODSLIST_DATA;	
    ...
    private DataManager() {
		...
		TRADEINGOODSLIST_DATA = data.tradeInGoodsListData;
		...
		ACADEMY_TELEPORT_DATA = data.academyTeleportData;
		ACADEMY_SHIGO_DATA = data.academyShigoData;
		ACADEMY_DATA = data.academyData;
		ACADEMY_BOX_DATA = data.academyBoxData;
		ACADEMY_SOLO_DATA = data.academySoloData;
