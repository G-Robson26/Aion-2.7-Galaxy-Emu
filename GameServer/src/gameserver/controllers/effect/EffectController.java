...
public class EffectController {
    ...
    public void removePhysicalEffect(int value,boolean itemCure) {
        ...
        for (Effect effect : abnormalEffectMap.values()) {
            ...
            if (effect.getTargetSlot() == SkillTargetSlot.BUFF.ordinal())
                continue;
			if(itemCure && (effect.containsEffectId(322) || effect.containsEffectId(672) || effect.containsEffectId(2090)))
				continue;
    ...
    public void removeAllEffects() {
        for (Effect effect : abnormalEffectMap.values()) {
            if(!effect.isXPBoostSkill() && !effect.isArtifactSkill())
            effect.endEffect();
        }
