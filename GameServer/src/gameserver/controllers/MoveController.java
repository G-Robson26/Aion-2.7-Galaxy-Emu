	...
	private void move()	{		
		...
		if(this.distance < speed){
			if(target != null && target instanceof Player)	{
				...
				//flying mobs
				if(owner.getObjectTemplate().getTemplateId() != 251018
			        && owner.getObjectTemplate().getTemplateId() != 254523
			        && owner.getObjectTemplate().getTemplateId() != 254524 
			        && owner.getObjectTemplate().getTemplateId() != 254527
			        && owner.getObjectTemplate().getTemplateId() != 251017)    
