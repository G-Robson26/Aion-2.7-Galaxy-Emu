...
public class Reload extends AdminCommand {
    ...
    public void executeCommand(Player admin, String[] params) {
        ...
        if (params == null || params.length != 1) {
            PacketSendUtility.sendMessage(admin, "syntax //reload <quest | skill | portal | spawn | admcmd | banmac>");
            return;
        }
        ...
        } else if(params[0].equals("banmac")){
        	BannedMacManager.getInstance().reload();
        	PacketSendUtility.sendMessage(admin, "Mac Address List reloaded successfully!");
        } else
            PacketSendUtility.sendMessage(admin, "syntax //reload <quest | skill | portal | spawn | admcmd | banmac>");
    }
