...
public class _10020ProvingYourselfToOutremus extends QuestHandler
{
	...
	public void register()
	{
		...
		qe.setNpcQuestData(798927).addOnTalkEvent(questId); // Outremus
		qe.setNpcQuestData(798928).addOnTalkEvent(questId); // Outremus
		qe.setNpcQuestData(798955).addOnTalkEvent(questId); // Outremus
		qe.setNpcQuestData(730223).addOnTalkEvent(questId); // Outremus
		qe.setNpcQuestData(730224).addOnTalkEvent(questId); // Outremus
		qe.setNpcQuestData(730225).addOnTalkEvent(questId); // Outremus
		qe.setNpcQuestData(700628).addOnTalkEvent(questId); // Outremus
		qe.setNpcQuestData(700629).addOnTalkEvent(questId); // Outremus
		qe.setNpcQuestData(700630).addOnTalkEvent(questId); // Outremus
