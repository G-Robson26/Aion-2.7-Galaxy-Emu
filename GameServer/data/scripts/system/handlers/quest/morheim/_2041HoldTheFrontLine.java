        ...
        switch (targetId) {
			...
			case 700183: { // Morheim Abyss Gate
                    if (qs.getQuestVarById(0) == 2) {
						...
						//updateQuestStatus(env);
						TeleportService.teleportTo(player, 320040000, 274.96f, 168.04f, 204.40f, 34);
                        return true;
                    }
                }
            case 204432: // Kargate 
                switch (env.getDialogId()) {
                    ...
                    case 10002:
                        if (var == 2) {
							...
							mobs.add((Npc) QuestService.addNewSpawn(320040000, 1, 213575, 252.914f, 261.48886f, 228.03635f, (byte) 63, true));
							mobs.add((Npc) QuestService.addNewSpawn(320040000, 1, 213575, 258.87332f, 262.55743f, 227.9683f, (byte) 94, true));
							mobs.add((Npc) QuestService.addNewSpawn(320040000, 1, 213575, 244.18814f, 259.57272f, 228.0447f, (byte) 3, true));
								for (Npc mob : mobs) {
